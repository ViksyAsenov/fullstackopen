...
describe('total likes', () => {
  test('should return 0 if blogs arr is empty', () => {
    const result = listHelper.totalLikes([])

    expect(result).toBe(0)
  })

  test('should return correct with one blog in arr', () => {
    const result = listHelper.totalLikes(listWithOneBlog)
    expect(result).toBe(7)
  })

  test('should return correct with many blogs in arr', () => {
...
describe('favourite blog', () => {
  test('should return {} if blogs arr is empty', () => {
